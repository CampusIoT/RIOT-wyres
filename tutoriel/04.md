...
![Schématique Led](images/schema_led.png)
...
ATTENTION! Toutes les cartes Wyre ne sont pas équipées d'un bouton.

Pour les cartes équipées, le programme suivant suit l'évolution de l'état du bouton:
