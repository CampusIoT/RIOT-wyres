...
<summary>Réponse</summary>
  <ul>
	...
	<li>Interupteur micro-bascule (micro-switch) pour détecter la mauvaise fermeture d'un boitier/d'armoire contenant un équipement électrique/électronique/mécanique/optique devant être protégé comme l'humidité, la pluie, le ruisselement, la poussière ...</li>
    <li> ... </li>
  </ul>
</details>
