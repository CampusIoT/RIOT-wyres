...
Une [bibliothèque pour Arduino](https://github.com/sparkfun/SparkFun_Weather_Meter_Kit_Arduino_Library) est disponible et peut-être utilisée pour réaliser une station météo avec la carte Wyres.
