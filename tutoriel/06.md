...
* pour lister les derniers messages reçus (relayés ou non) en gérant une file FIFO.
...
`123@*:18,3:Salut à tous en multi-sauts`: signifie de la part de 123 pour tout le monde (*) (message #18 émis par 123 avec un `ttl` de 3)
