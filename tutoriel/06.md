...
* `123@*:16:lpp03670110056700ff067104d2fb2e0000018806765ff2960a0003e8` : signifie de la part de `123` pour tout le monde (`*`), Telemetry au format LPP Cayenne pour `[{"temperature_3":27.2},{"temperature_5":25.5},{"accelerometer_6":{"x":1.234,"y":-1.234,"z":0}},{"gps_1":{"latitude":42.3519,"longitude":-87.9094,"altitude":10}}]`
...
`123@*:16,3:Salut à tous en multi-sauts`: signifie de la part de 123 pour tout le monde (*) (message #16 émis par 123 avec un `ttl` de 3)
