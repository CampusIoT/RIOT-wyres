...
A la réception, un noeud attends `RelayDelay` millisecondes avant de répeter un message. La valeur de `RelayDelay` depends du SF, de la BW, du Preamble et du SNR de la réception.
