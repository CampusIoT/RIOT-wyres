...
A partir des exemples précédents, interfacez la carte Wyres par le port UART au port du Minitel 📺 via la carte d'adaptation des niveau de tension 12V0 -> 3V3 pour envoyer des messages dans des paquets LoRaWAN et pour afficher les messsages texte recus.
