...
```
loramac_txhex 01020304 uncnf 10
```
...
Vous observerez les 2 clés de session utilisés désormais par la carte et le serevur pour sécuriser les échanges (uplink et downlink) ainsi que la valeur des 2 compteurs (uplink et downlink)

Vérifiez que ce sont bien les mêmes
