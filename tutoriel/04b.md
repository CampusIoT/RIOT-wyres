...
Le capteur de distance à ultrason HC-SR04 sert à mesurer la distance entre le capteur et un objet en utilisant des ondes ultrasonores (généralement à 40 kHz).

Le principe de fonctionnement est le suivant :
* 1.	Le capteur envoie une impulsion ultrasonore (émise par le transmetteur) via la broche TRIG.
* 2.	Cette onde se réfléchit sur un objet et revient vers le récepteur via la broche ECHO.
* 3.	En connaissant la vitesse du son (~340 m/s), il calcule la distance à partir du temps aller-retour de l’onde
...
<li>présence/absence d'un colis dans une boite à lettre / dans une consigne</li>
<li>niveau de remplissage d'un conteneur (urbain, cave collective ...) de déchet</li>
