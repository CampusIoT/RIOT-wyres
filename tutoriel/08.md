...
[Précédent](07b.md) | [Top](README.md) |  [Suivant](09.md)
...
![rule-engine-2-0](https://img.thingsboard.io/user-guide/rule-engine-2-0/tutorials/getting-started/)initial-root-chain-ce.png)
...
La requête est équivalent à une commande `cURL` suivante:
