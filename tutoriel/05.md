...
## Capteur de pression atmosphérique et de températeur [ST LPS22HB](https://www.st.com/en/mems-and-sensors/lps22hb.html)
...
### Capteur THP Sensirion SHT3x et SHT85

```bash
cd ~/github/RIOT-OS/RIOT/tests/drivers/sht3x/
make -j 4 flash
```
...
### Sensirion SHT2x, SHT3x et [SHT4x](https://sensirion.com/media/documents/33FD6951/662A593A/HT_DS_Datasheet_SHT4x.pdf)

TODO

https://doc.riot-os.org/group__drivers__sht3x.html
