...
RIOT suppose seulement les capteurs de la sous-gamme []`vl6180x`](https://github.com/RIOT-OS/RIOT/tree/master/drivers/vl6180x).
...
* une sonde PT100/PT1000
* une sonde de pression de l'eau (niveau de cuve)
* ...
