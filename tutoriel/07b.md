...
Le tableau ci-dessous donne les différents temps de vol (Time On Air) pour différents tailles de charge utile (13, 51, 115, 222) et plus des 13 octets pour l'entête, le FPort et le MIC.

| DataRate | ToA pour 13 octets | ToA pour 51 octets | ToA pour 115 octets | ToA pour 222 octets |
| -------- | -------- | -------- | -------- | -------- |
...
> Note: [Ce calcultaeur en ligne](https://avbentem.github.io/airtime-calculator/ttn/eu868/13,13) permet de connaître le temps de vol (time on air) d'un message LoRaWAN en fonction de sa taille et du datarate utilisé par l'équipement.
...
> Note: les prochaines spécifications de la LoRa Alliance a ajouté de nouveaux datarates (`DR8` à `DR11`) liés à l'utilisation de la modulation LR-FHSS qui est disponible dans les composants Semtech SX126x, LLCC68 et LR11xx. Le démodulation des messages LR-FHSS par les stations n'est actuellemnt pas généralisée.
